...
const test = (dyn) => (
  <>
    <Spinner renderTitle="a" themeOverride={{ xSmallBorderWidth: '1rem' }} />
    <Spinner renderTitle="b" themeOverride={{ smallSize: '2rem' }} />
    ...
    <InstUISettingsProvider
      theme={{ componentOverrides: { Text: { secondaryColor: 'grey' } } }}
    >
      <Text>y</Text>
    </InstUISettingsProvider>
