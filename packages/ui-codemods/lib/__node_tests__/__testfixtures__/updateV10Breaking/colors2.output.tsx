  ...
  return (
    ...
    >
      ...
      <View
        background="primary"
        themeOverride={{
          backgroundPrimary: canvas.colors?.contrasts?.grey100100
        }}
        as="div"
      >
        <View
          background="primary"
          themeOverride={{
            backgroundPrimary: canvas.colors?.contrasts?.grey125125
          }}
          as="div"
        >
                  ...
                  trigger={
                    ...
                    >
                      <Text
                        ...
                        color="primary"
                        themeOverride={{
                          primaryColor: canvas.colors?.contrasts?.grey1214
                        }}
                      >
                        {currentClient?.name}
                                ...
                                <Text
                                  ...
                                  themeOverride={{
                                    primaryColor:
                                      variant === 'highlighted'
                                        ? 'white'
                                        : canvas.colors?.contrasts?.grey4570
                                  }}
                                >
                                  {bank.item_count}
                                </Text>
      ...
      >
        ...
        <Modal.Body>
          ...
          <View
            ...
            display="flex"
            themeOverride={{
              backgroundPrimary: canvas.colors?.contrasts?.grey1111
            }}
          >
            <IconInfoLine
              size="x-small"
              color="primary"
              themeOverride={{
                primaryColor: canvas.colors?.contrasts?.grey4570
              }}
            />
            <View margin="0 0 0 small" as="span">
              <Text
                color="primary"
                themeOverride={{
                  primaryColor: canvas.colors?.contrasts?.grey100100
                }}
              >
        ...
        <div>
          {option.type === 'ITEM' ? (
            <IconBulletListSolid
              color="primary"
              themeOverride={{
                primaryColor: isHighlighted
                  ? canvas.colors?.contrasts?.blue4570
                  : 'white'
              }}
            />
          ) : (
          ...
          <div>
            <Text
              ...
              themeOverride={{
                primaryColor: isHighlighted
                  ? 'white'
                  : canvas.colors?.contrasts?.green4570
              }}
            >
              {option.Bank.title}
            </Text>
