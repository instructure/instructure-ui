...
- **ui-list:** Removed "variant" property: use InlineList component for inline lists and isUnstyled boolean prop
  for unstyled lists. Removed inline delimiter values (pipe, slash and arrow) from "delimiter"
  property.
