...
- Deprecate DateTime. This is a thin wrapper around moment.js, please use moment or some other time library instead.
...
- **Decimal:** fix toLocaleString ([b32e06c](https://github.com/instructure/instructure-ui/commit/b32e06c))
