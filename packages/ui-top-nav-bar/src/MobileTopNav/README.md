...
const Example = () => {
  const brandSvg = (
    <a style={{width: '28px', height: '28px', display: 'flex', alignItems: 'center', justifyContent: 'center'}} href="#">
  ...
  return (
    <div style={{position: 'relative', width: '420px', maxWidth: '100%', boxSizing: 'borderBox'}}>
