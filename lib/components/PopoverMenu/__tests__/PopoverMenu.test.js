...
describe('<PopoverMenu />', function () {
  ...
  it('should render when show and onToggle props are set', function () {
    const subject = testbed.render({
      show: true,
      onToggle: () => {}
    })
  ...
  it('should call onToggle on click', function () {
  ...
  it('should call onFocus on focus', function () {
  ...
  it('should have an aria-haspopup attribute', function () {
    const subject = testbed.render()
