...
describe('<TreeCollection />', function () {
  ...
  describe('collections', function () {
    ...
    it('calls any custom functions passed by onCollectionClick prop', function () {
      const onCollectionClick = testbed.sandbox.stub()
      const collection = testbed.render({
  ...
  describe('items', function () {
    ...
    it('calls any custom functions passed by onItemClick prop', function () {
      const onItemClick = testbed.sandbox.stub()
      const collection = testbed.render({
