...
export default class DateInput extends Component {
  ...
  handleTextInputChange = e => {
    ...
    const rawConversionFailed = newTextValue !== '' && !newMoment.isValid()
    const newMessages = []
    ...
    this.fireOnChange(e, newMoment, newTextValue, rawConversionFailed)
  }
  ...
  handleDatePickerChange = (e, newValue) => {
    ...
    this.fireOnChange(e, newMoment, textInputValue, !newMoment.isValid())
  }
