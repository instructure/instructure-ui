...
export default class DateInput extends Component {
  ...
  static propTypes = {
    ...
    **/
    ...
    /**
      ...
      The parameters are the new date value in ISO 8601 format and the raw user input.
    **/
  ...
  handleTextInputChange = (e) => {
    ...
    this.fireOnChange(newMoment, newTextValue)
  }
  ...
  handleDatePickerChange = (newValue) => {
    ...
    this.fireOnChange(newMoment, newValue)
  }

  fireOnChange (newMoment, rawValue) {
    if (typeof this.props.onDateChange === 'function') {
      if (newMoment.isValid()) {
        this.props.onDateChange(newMoment.format(), rawValue)
      } else {
        this.props.onDateChange(null, rawValue)
      }
    }
  }
