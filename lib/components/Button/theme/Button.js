...
export default function ({ borders, colors, typography }) {
  ...
  const _base = {
    ...
    iconTextColor: colors.colorTextSecondary,
    iconTextColorInverse: colors.colorTextInverse,

    iconTextColorHover: colors.colorBrand,
    iconTextColorHoverInverse: colors.colorTextInverse,

    iconFocusOutlineColor: colors.colorFocusAccent,
    iconFocusOutlineColorInverse: colors.colorFocusInverse
  }
