...
/**
  ...
  ```jsx_example
  <div>
    <Button variant="primary" margin="0 x-small 0 0">Primary button</Button>
    <Button variant="success" margin="0 x-small 0 0">Success button</Button>
    <Button variant="light" margin="0 x-small 0 0">Light Button</Button>
    <Button variant="ghost" margin="0 x-small 0 0">Ghost Button</Button>
