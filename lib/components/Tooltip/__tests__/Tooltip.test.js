...
describe('<Tooltip />', function () {
  describe('using as', function () {
    ...
    it('should have an aria-describedby attribute', function () {
      const subject = testbed.render()
    ...
    it('should pass down the href attribute', function () {
      const subject = testbed.render()
  ...
  describe('using children', function () {
    const testbed = new Testbed(
      <Tooltip tip={<Heading>Hello</Heading>} children={<span />} />
    )

    it('should call onClick of child', function () {
