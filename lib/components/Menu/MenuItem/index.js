...
class MenuItem extends Component {
  ...
  handleKeyDown = (e) => {
    ...
    if (spaceKey || enterKey) {
      ...
      if (enterKey) { // handle space key on keyUp for FF
        ReactDOM.findDOMNode(this._node).click() // eslint-disable-line react/no-find-dom-node
      }
    }
  }
  ...
  focus () {
    ReactDOM.findDOMNode(this._node).focus() // eslint-disable-line react/no-find-dom-node
  }
