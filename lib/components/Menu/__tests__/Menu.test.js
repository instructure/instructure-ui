...
describe('<Menu />', function () {
  ...
  it('should call onClose after Esc or Tab press', function () {
    ...
    keyCodes.forEach(function (keyCode) {
      ...
      subject.simulate('keyDown', { keyCode: keyCode })
  ...
  it('should move focus properly', function () {
    ...
    subject.simulate('keyDown', {keyCode: 38})
    expect(subject.instance().focusedIndex).to.equal(6)
    subject.simulate('keyDown', {keyCode: 40})
    expect(subject.instance().focusedIndex).to.equal(0)
  })
