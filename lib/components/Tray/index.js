...
class Tray extends Component {
  ...
  transitionType () {
    return classnames({
      'slide-down': (
        (
          this.props.placement === 'top' && this.props.open
        ) || (
          this.props.placement === 'bottom' && !this.props.open
        )
      ),
      'slide-up': (
        (
      ...
      'slide-left': (
        (
          this.props.placement === 'start' && !this.props.open
        ) || (
          this.props.placement === 'end' && this.props.open
        )
      ),
      'slide-right': (
        (
