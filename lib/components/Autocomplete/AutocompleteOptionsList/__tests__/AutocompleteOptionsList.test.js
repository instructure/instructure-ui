...
describe('<AutocompleteOptionsList />', function () {
  ...
  it('should set selectedOption correctly', function () {
    const subject = testbed.render({
      selectedOption: {
        label: 'Alaska',
        value: '1',
  ...
  it('should set highlightedIndex correctly', function () {
    const subject = testbed.render({
      highlightedIndex: 2
    })
  ...
  it('should call onHighlightOption', function () {
  ...
  it('should call onStaticClick when static option is selected', function () {
