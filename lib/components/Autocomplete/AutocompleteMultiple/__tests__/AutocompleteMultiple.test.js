...
describe('<AutocompleteMultiple />', function () {
  ...
  it('resets input value to empty when closing the menu with selectedOption', function () {
    const subject = testbed.render({
      selectedOption: ['1']
    })
    testbed.tick()
  ...
  it('selection is additive', function () {
    const newSelection = {
  ...
  it('renders Tags for each selectedOption', function () {
    const subject = testbed.render({
      selectedOption: [{
        value: '4', label: 'Key Largo'
      }, {
  ...
  it('handles dismissing Tags', function () {
    const onChange = testbed.stub()
    const subject = testbed.render({
      onChange,
      selectedOption: [{
