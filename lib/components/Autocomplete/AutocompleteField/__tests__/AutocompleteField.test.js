...
describe('<AutocompleteField />', () => {
  ...
  it('placement should be bottom start by default', () => {
    const subject = testbed.render()
  ...
  it('placement should be bottom end by default when layout is inline', () => {
  ...
  it('renders only loadingOption when given and loading is true', () => {
