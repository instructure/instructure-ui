...
describe('<NumberInput />', function () {
  ...
  describe('NumberInput.applyStep', function () {
    it('should add steps', function () {
      const subject = testbed.render({ defaultValue: '0', step: '1' }).instance()
      expect(subject.applyStep(1)).to.equal('1')
    })

    it('should subtract steps', function () {
      const subject = testbed.render({ defaultValue: '0', step: '1' }).instance()
      expect(subject.applyStep(-1)).to.equal('-1')
    })

    it('should support fractional steps', function () {
    ...
    describe('with large numbers', function () {
      ...
      it('should substract steps', function () {
      ...
      it('should not use scientific notation', function () {
    ...
    describe('when the input is empty', function () {
      it('should assume value is 0 web adding steps', function () {
        const subject = testbed.render({ defaultValue: '', step: '123' }).instance()
        expect(subject.applyStep(1)).to.equal('123')
      })

      it('should assume value is 0 when subtracting steps', function () {
        const subject = testbed.render({ defaultValue: '', step: '123' }).instance()
        expect(subject.applyStep(-1)).to.equal('-123')
      })
    })

    describe('with a min prop', function () {
