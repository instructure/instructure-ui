...
describe('<NumberInput />', function () {
  ...
  describe('NumberInput.applyStep', function () {
    ...
    it('should add step for large numbers', function () {
    ...
    it('should substract step for large numbers', function () {
    ...
    it('should not turn large numbers into scientific notation', function () {
