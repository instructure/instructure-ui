...
describe('Badge.theme', function () {
  describe('with the default theme', function () {
    const variables = Badge.generateTheme()

    it('should have a default background and text colors that meet 3:1 contrast', function () {
      expect(contrast(variables.colorPrimary, variables.color)).to.be.above(3)
    })
    it('should have a success variant background and text colors that meet 3:1 contrast', function () {
      expect(contrast(variables.colorSuccess, variables.color)).to.be.above(3)
    })
    it('should have a danger variant background and text colors that meet 3:1 contrast', function () {
