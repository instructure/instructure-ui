...
describe('<Modal />', function () {
  ...
  it('should not dismiss when overlay clicked by default', function () {
  ...
  it('should dismiss when overlay clicked with prop', function () {
    const onDismiss = testbed.stub()
    const subject = testbed.render({
      open: true,
  ...
  it('should dismiss when close button is clicked', function () {
    const onDismiss = testbed.stub()
    const subject = testbed.render({
      open: true,
      onDismiss
...
describe('<Modal /> managed focus', function () {
  ...
  it('should call onDismiss prop when Esc key pressed', function () {
    const onDismiss = testbed.stub()
    let contentEl
    testbed.render({
      open: true,
