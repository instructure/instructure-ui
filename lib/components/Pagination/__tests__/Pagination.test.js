...
describe('<Pagination />', function () {
  ...
  context('compact', function () {
    ...
    it('should render a single page', function () {
      const subject = compactTestbed.render({
    ...
    it('should render no pages', function () {
    ...
    it('should truncate pages to context', function () {
    ...
    it('should truncate start', function () {
    ...
    describe('arrows', function () {
      it('should render only when applicable', function () {
      ...
      it('should navigate to adjacent pages', function () {
