...
describe('<DatePicker />', function () {
  ...
  it('styles today date', function () {
    const subject = testbed.render()
    expect(subject.find(`.${styles.today}`)).to.be.present
  })

  it('styles the selected date', function () {
    const subject = testbed.render()
    expect(subject.find(`.${styles.selected}`)).to.be.present
  })

  it('styles dates outside the selected month', function () {
    const subject = testbed.render()
    expect(subject.find(`.${styles.outside}`).length).to.be.above(0)
  })

  it('fires onSelectedChange when date is clicked', function () {
  ...
  it('fires onRenderedChange when next arrow is clicked', function () {
  ...
  it('fires onRenderedChange when previous arrow is clicked', function () {
    const onRenderedChange = testbed.stub()
    const subject = testbed.render({onRenderedChange})
  ...
  it('localizes the calendar layout', function () {
  ...
  it('localizes the header', function () {
  ...
  it('uses the specified timezone', function () {
    const onSelectedChange = testbed.stub()
    const subject = testbed.render(
  ...
  it('gets locale and timezone from context', function () {
  ...
  it('overrides locale and timezone context with properties', function () {
  ...
  it('defaults the selected value to the today value', function () {
    const subject = testbed.render({todayValue: '2017-04-01'})
    expect(subject.instance().selectedValue()).to.equal('2017-04-01')
  })

  it('defaults the rendered value to the selected value', function () {
  ...
  it('should focus next day on key right', function () {
  ...
  it('should focus previous day on key left', function () {
    const subject = testbed.render({timezone: 'Europe/Paris', defaultSelectedValue: '2017-05-01'})
  ...
  it('should focus next week on key down', function () {
    const subject = testbed.render({timezone: 'Europe/Paris', defaultSelectedValue: '2017-05-01'})
  ...
  it('should focus previous week on key up', function () {
    const subject = testbed.render({timezone: 'Europe/Paris', defaultSelectedValue: '2017-05-01'})
  ...
  it('should move slider to a different month when focus moves out of month', function () {
    const onRenderedChange = testbed.stub()
    const subject = testbed.render({
  ...
  it('should move slider to a different month when date is selected out of month', function () {
    const onRenderedChange = testbed.stub()
    const subject = testbed.render({
      defaultSelectedValue: '2017-05-01',
      onRenderedChange
