...
/**
  ...
  <div>
    <Checkbox
      label="You are usually the first to react to a sudden event:
        the telephone ringing or unexpected question. You spend your
        leisure time actively socializing with a group of people,
        attending parties, shopping, etc."
      value="extravert" defaultChecked />
    <Checkbox
      label="After prolonged socializing you feel you need to get
        away and be alone. You usually place yourself nearer to
