...
```jsx_example
  <ContextBox showArrow={false} withAnimation={false}>
    <UserCard
...
When used on its own the UserCard component has no border or drop shadow, but has
a width set to match the width of the [Avatar](#Avatar) component.

```jsx_example
   <UserCard
     userName="Valentina Seraphinia"
