...
describe('<Popover />', function () {
  ...
  function testShowContent (on, eventType) {
    it(`should show content on ${on}`, function () {
  ...
  it('should not render content by default', function () {
  ...
  it('should close when clicked outside content by default', function () {
    const subject = testbed.render()
    const button = subject.find(Button)
  ...
  it('should close when trigger is clicked', function () {
    const subject = testbed.render()
    const button = subject.find(Button)
  ...
  describe('controlled', function () {
    it('should show content if defaultShow is true', function () {
    ...
    it('should not show content on click', function () {
      const onToggle = testbed.spy()
      const subject = testbed.render({ show: false, onToggle })
      const button = subject.find(Button)
