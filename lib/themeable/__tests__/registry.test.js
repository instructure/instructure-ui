...
describe('registry', function () {
  ...
  describe('#makeUsable', function () {
    it('should allow configuring an accessible theme and provide a way to set it as the default', function () {
      const usable = makeTheme({
        theme: bar,
        a11y: accessible
      })
  ...
  describe('#generateTheme', function () {
    ...
    it('should NOT allow overriding an accessible theme', function () {
  ...
  describe('#generateComponentTheme', function () {
    ...
    it('should generate a component theme when no themes are registered', function () {
      clearRegistry()
