export default Object.freeze({
  ...
  // these need to meet 3:1 contrast as background with text colors porcelain and lightest
  // or as text with background porcelain and lightest
  darkest: '#2D3B45',
  oxford: '#394B58',
  ...
  // these need to meet 3:1 contrast as background with text colors oxford and darkest
  // and as text with backround colors oxford and darkest
  porcelain: '#F5F5F5',
  lightest: '#FFFFFF'
})
