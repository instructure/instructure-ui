...
describe('a11y.colors', function () {
  ...
  describe('shamrock', function () {
    it('should meet 4.5:1 contrast as a background color with `lightest` text', function () {
      expect(contrast(colors.shamrock, colors.lightest)).to.be.above(4.5)
    })
  })
  ...
  describe('licorice', function () {
    ...
    it('should meet 4.5:1 contrast as a background color with `lightest` text', function () {
      expect(contrast(colors.licorice, colors.lightest)).to.be.above(4.5)
    })
  })
  ...
  describe('lightest', function () {
    it('should meet 4.5:1 contrast as a background color with `licorice` text', function () {
      expect(contrast(colors.lightest, colors.licorice)).to.be.above(4.5)
    })
    it('should meet 4.5:1 contrast as a background color with `oxford` text', function () {
