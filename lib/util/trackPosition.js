...
import getAbsoluteBoundingClientRect from './getAbsoluteBoundingClientRect'
...
export default function trackPosition (componentOrElement, cb) {
  ...
  let coords = getAbsoluteBoundingClientRect(el) || {}
  let cancelled = false
  ...
  function tick () {
    ...
    const temp = getAbsoluteBoundingClientRect(el) || {}
