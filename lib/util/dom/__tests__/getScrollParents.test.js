...
describe('getScrollParents', function () {
  ...
  it('should find scroll parent for inline elements', function () {
    testbed.render()
  ...
  it('should ignore static parents when absolute', function () {
    testbed.render()
  ...
  it('should handle fixed', function () {
    testbed.render()
