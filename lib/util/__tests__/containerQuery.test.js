...
describe('@containerQuery', function () {
  ...
  it('adds attributes to the container element based on its dimensions and the query', function () {
    ...
    testbed.mockRaf.step(10)

    expect(testbed.dom.node.getAttribute('data-width_less_than_200')).to.not.exist
    ...
    expect(testbed.dom.node.getAttribute('data-width_less_than_200')).to.exist
  })
  ...
  it('converts rem units in the query to pixels', function () {
    ...
    expect(testbed.dom.node.getAttribute('data-width_between_251_and_300')).to.not.exist
    ...
    expect(testbed.dom.node.getAttribute('data-width_between_251_and_300')).to.exist
  })
