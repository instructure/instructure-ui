...
export default function themeable (themeVariables, themeStyles) {
  return function (ComposedComponent) {
    ...
    return class extends ComposedComponent {
      ...
      renderTheme () {
        return (
          <ScopedStyle scope={'[data-theme-id="' + this.themeId + '"]'} key={this.themeId}>
      ...
      render () {
        ...
        return safeCloneElement(componentTree, props, [this.renderTheme()].concat(React.Children.toArray(children)))
      }
    }
  }
}
