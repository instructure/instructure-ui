...
Current tests can be found next to the component source code in the `__tests__` subfolder. New tests should also be added there. You can name the file as you like, but make sure it has the `*.test.tsx` extension.


`/ui-avatar/src/Avatar/__tests__/YourTestFile.test.tsx`
