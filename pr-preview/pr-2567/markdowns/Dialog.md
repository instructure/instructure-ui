...
| Dialog | style | `React.CSSProperties` | No | - | Inline styles applied to the root element. Merged with the default `borderRadius: inherit` so consumers can override it. |
