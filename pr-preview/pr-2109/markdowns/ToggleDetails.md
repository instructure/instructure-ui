...
| ToggleDetails | expanded | `custom` | No | - | Whether the content is expanded or hidden |
| ToggleDetails | defaultExpanded | `bool` | No | `false` | Whether the content is initially expanded or hidden (uncontrolled) |
...
import { ToggleDetails } from '@instructure/ui-toggle-details/es/ToggleDetails/index'
```
