...
|-----------|------|------|----------|---------|-------------|
| View | as | `union` | No | - | The element to render as the component root, `span` by default |
| View | elementRef | `signature` | No | - | provides a reference to the underlying html element |
| View | display | `union` | No | `'auto'` | By default the display prop is 'auto', meaning it takes on the display rules of the html element it's rendered as (see `as` prop). |
| View | overflowX | `union` | No | `'visible'` |  |
| View | overflowY | `union` | No | `'visible'` |  |
...
| View | height | `union` | No | - |  |
| View | width | `union` | No | - |  |
| View | maxHeight | `union` | No | - |  |
| View | maxWidth | `union` | No | - |  |
| View | minHeight | `union` | No | - |  |
| View | minWidth | `union` | No | - |  |
| View | children | `ReactReactNode` | No | - | The children to render inside the <View /> |
| View | textAlign | `union` | No | - | Designates the text alignment within the `<View />` |
...
| View | borderColor | `union` | No | `'primary'` | Sets the color of the View border. Accepts a color string value (e.g., "#FFFFFF", "red") or one of the predefined theme color options. |
| View | background | `union` | No | - | Designates the background style of the `<View />` |
...
| View | position | `union` | No | `'static'` | Specify a value for the CSS position property. Use `relative` if `focusable` will be true. |
...
| View | focusPosition | `union` | No | `'offset'` | Determines whether the focus outline displays offset or inset from the focused View |
| View | focusColor | `union` | No | `'info'` | Determines the color of the focus outline |
...
| View | overscrollBehavior | `union` | No | `'auto'` | Sets what a browser does when reaching the boundary of a scrolling area. Valid values are `auto`, `contain`, `none`. |
