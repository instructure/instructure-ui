...
| ColorContrast | withoutColorPreview | `bool` | No | `false` | Toggles the color preview part of the component. If true, firstColorLabel and secondColorLabel is not necessary. Otherwise, it is required. |
...
import { ColorContrast } from '@instructure/ui-color-picker/es/ColorContrast/index'
```
