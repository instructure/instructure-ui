...
| Position | shouldTrackPosition | `bool` | No | `true` | Whether or not position of the target should be tracked or just set statically on render |
| Position | shouldPositionOverTarget | `bool` | No | `false` | Whether or not you want the content to position over the target |
...
import { Position } from '@instructure/ui-position/es/Position/index'
```
