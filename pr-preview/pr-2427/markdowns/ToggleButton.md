...
| ToggleButton | renderIcon | `Renderable` | Yes | - | An icon or function that returns an icon |
...
| ToggleButton | as | `AsElementType` | No | `'button'` | The element to render as the component root; `button` by default |
