...
| FileDrop | renderLabel | `Renderable<RenderLabelProps>` | Yes | - | The content of FileDrop; can be a component or React node. Components receive `isDragAccepted` and `isDragRejected` as props. |
