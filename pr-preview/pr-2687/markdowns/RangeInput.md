...
| RangeInput | thumbVariant | `'deprecated' \| 'accessible'` | No | `'deprecated'` | The "deprecated" variant has an outer shadow on focus. The "accessible" variant has better color contrast, border and inset focus ring for better accessibility. |
